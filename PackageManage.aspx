<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PackageManage.aspx.cs" Inherits="PackageManage" ValidateRequest="false"%>
            ...
            <div class="GridView" style="padding:10px;">
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr class="GridViewItemNormal">
			            ...
			            <td style="text-align:left;padding-left:10px;">
				            <asp:TextBox ID="txtPrice" runat="server" Text="0"/> บาท
			            </td>
		            </tr>
                    <tr class="GridViewItemNormal">
                        <td>
