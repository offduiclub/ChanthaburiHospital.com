<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HealthPackageManage.aspx.cs" Inherits="HealthPackageManage" ValidateRequest="false"%>
            ...
            <div class="GridView" style="padding:10px;">
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr class="GridViewItemNormal">
			            ...
			            <td style="text-align:left;padding-left:10px;">
			                <asp:TextBox ID="txtPrice" runat="server" Width="50px" />
                            <asp:CompareValidator ID="CompareValidator1"
                                runat="server" ErrorMessage="โปรดกรอกตัวเลข" CssClass="vldDefault" 
                                Display="Dynamic" SetFocusOnError="True" Type="Double" 
                                ControlToValidate="txtPrice" Operator="DataTypeCheck"></asp:CompareValidator>
			            </td>
		            </tr>
                    <tr class="GridViewItemNormal">
                        <td>
