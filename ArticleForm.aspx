<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ArticleForm.aspx.cs" Inherits="ArticleForm" ValidateRequest="false" %>
...
<body>
    ...
    <div class="GridView">
        ...
        <table align="center" cellpadding="0" cellspacing="0" class="tbGridView" style="font-weight: normal"
            ...
            <tr class="GridViewItem">
                <td style="text-align: right; padding-right: 10;">
                    <asp:Label ID="lblImages" runat="server" Text="Imanges : "></asp:Label>
                </td>
                <td style="text-align: left; padding-left: 10;">
                    ...
                    <asp:FileUpload ID="txtImanges" runat="server" />
                </td>
            </tr>
            <tr class="GridViewItem">
                <td style="text-align: right; padding-right: 10;">
