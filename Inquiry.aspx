<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Inquiry.aspx.cs" Inherits="Inquiry" culture="auto" meta:resourcekey="PageResource1" uiculture="auto"%>
    ...
    <div id="dvHeader">
        ...
        <div style="float:left;">
            <div style="text-align:left;">
                <div>
                    <asp:Label ID="lblName" runat="server" Text="<h1>Inquiry</h1>" meta:resourcekey="lblNameResource1"/>
                </div>
                <div>
                    <asp:Label ID="lblDetail" runat="server" Text="Inquiry" meta:resourcekey="lblDetailResource1"/>
                </div>
                ...
                <table cellpadding="0" cellspacing="0" style="width:100%;">
                    <tr>
                        <td style="width:200px;" class="columnLeft">
                            <asp:Label ID="lblMedicalCenter" runat="server" Text="ศูนย์ที่เกี่ยวข้อง" meta:resourcekey="lblMedicalCenterResource1" />
                        </td>
                        <td class="columnRight">
                            <asp:DropDownList ID="ddlMedicalCenter" runat="server" CssClass="txtDefault" meta:resourcekey="ddlMedicalCenterResource1" />
                        </td>
                    </tr>
                    <tr>
                        <td class="columnLeft">
                    ...
                    <tr>
                        <td class="columnLeft">
                            <asp:Label ID="lblMessage" runat="server" Text="ข้อความถึงโรงพยาบาล" meta:resourcekey="lblMessageResource1"/>
                        </td>
                        <td class="columnRight">
