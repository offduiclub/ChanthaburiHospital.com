<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmailTemplateManage.aspx.cs" Inherits="EmailTemplateManage" ValidateRequest="false"%>
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr class="GridViewItemNormal">
                        <td>
                            Subject</td>
                        <td style="text-align:left;padding-left:10px;">
                            <asp:TextBox ID="txtSubject" runat="server" MaxLength="200" width="99%" />
                        </td>
                    </tr>
                    <tr class="GridViewItemNormal">
                        <td>
                            Message</td>
                        <td style="text-align:left;padding-left:10px;">
                            <uc3:ucTextEditor ID="ucTextEditor1" runat="server" Width="100%"/>
                        </td>
                    </tr>
                    <tr class="GridViewItemNormal">
                        <td>
