...
public partial class Management_Service : System.Web.UI.Page
{
    #region Global Variable
    public clsDefault clsDefault = new clsDefault();
    clsSQL clsSQL = new clsSQL();
    clsSecurity clsSecurity = new clsSecurity();
    public string pathUpload = "/Upload/Service/";
    public string tableDefault = "Service";
    public string webDefault = "Service.aspx";
    public string webManage = "ServiceManage.aspx";
    #endregion
    ...
    protected void BindDefault()
    {
        ...
        lblHeader.Text = clsSQL.Return("SELECT Name FROM ServiceGroup WHERE UID=" + clsDefault.QueryStringChecker("group"), dbType, cs);
        #endregion
        #region SQL Query
        ...
        #region Where
        strSQL.Append("WHERE ");
        strSQL.Append("ServiceGroupUID=" + clsDefault.QueryStringChecker("group") + " ");
        #endregion
    ...
    protected void btDGSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            ucColorBox1.Redirect("/Management/" + webDefault + "?group=" + clsDefault.QueryStringChecker("group"), "ดำเนินการเสร็จสิ้น", "แก้ไขข้อมูลเสร็จเรียบร้อย");
        }
        else
        {
