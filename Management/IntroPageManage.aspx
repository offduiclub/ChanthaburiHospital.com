<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IntroPageManage.aspx.cs" Inherits="Management_IntroPageManage" %>
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr class="GridViewItemNormal">
                        <td>
                            วันเริ่มใช้</td>
                        <td style="text-align:left;padding-left:10px;">
                            <uc3:ucDateTimeFlat ID="ucActiveFrom" runat="server" />
                        </td>
                    </tr>
                    <tr class="GridViewItemNormal">
                        <td>
                            วันหยุดใช้</td>
                        <td style="text-align:left;padding-left:10px;">
                            <uc3:ucDateTimeFlat ID="ucActiveTo" runat="server" />
                        </td>
                    </tr>
                    <tr class="GridViewItemNormal">
                        <td>
                            ทำซ้ำทุกปี</td>
                        <td style="text-align:left;padding-left:10px;">
                            <asp:CheckBox ID="cbActiveIgnoreYear" runat="server" />
                        </td>
                    </tr>
                    <tr class="GridViewItemNormal">
                        <td>
