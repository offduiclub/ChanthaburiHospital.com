<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="ServiceManage.aspx.cs" Inherits="Management_ServiceManage" ValidateRequest="false"%>
            ...
            <div class="GridView" style="padding:10px;">
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr class="GridViewItemNormal">
			            ...
			            <td style="text-align:left;padding-left:10px;">
				            <asp:TextBox ID="txtDepartmentUID" runat="server" Width="30px" CssClass="txtCenter"/>
                            <span class="fontComment"> * ใช้อ้างอิงกับรหัสแผนกในตารางแพทย์</span>
			            </td>
		            </tr>
                    <tr class="GridViewItemNormal">
                        <td>
                    ...
                    <tr class="GridViewItemNormal">
			            ...
			            <td style="text-align:left;padding-left:10px;">
			                <uc3:ucTextEditorFull ID="ucPrice" runat="server" Row="4"/>
			            </td>
		            </tr>
                    <tr class="GridViewItemNormal">
                        <td>
			            ...
			            <td style="text-align:left;padding-left:10px;">
			                <asp:TextBox ID="txtLocation" runat="server" MaxLength="200" width="400" />
			            </td>
		            </tr>
                    <tr class="GridViewItemNormal">
                        <td>
			            ...
			            <td style="text-align:left;padding-left:10px;">
				            <asp:TextBox ID="txtOfficeHours" runat="server" MaxLength="200" width="400" />
			            </td>
		            </tr>
                    <tr class="GridViewItemNormal">
                        <td>
			            ...
			            <td style="text-align:left;padding-left:10px;">
				            <asp:TextBox ID="txtPhone" runat="server" MaxLength="100" width="200" />
			            </td>
		            </tr>
                    <tr class="GridViewItemNormal">
                        <td>
			            ...
			            <td style="text-align:left;padding-left:10px;">
				            <asp:TextBox ID="txtEMail" runat="server" MaxLength="100" width="200" />
			            </td>
		            </tr>
                    <tr class="GridViewItemNormal">
                        <td>
