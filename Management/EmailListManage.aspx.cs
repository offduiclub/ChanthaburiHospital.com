...
public partial class Management_EmailListManage : System.Web.UI.Page
{
    ...
    public string tableDefault = "EmailList";
    public string webDefault = "EmailList.aspx";
    public string webManage = "EmailListManage.aspx";
    #endregion
    ...
    protected void BindDetail(string id)
    {
        ...
        strSQL.Append(tableDefault + ".EMailAliasName,");
        ...
        if (dt != null && dt.Rows.Count > 0)
        {
            ...
            txtEMailAliasName.Text = dt.Rows[0]["EMailAliasName"].ToString();
        ...
        if (Request.QueryString["id"] != null && clsDefault.QueryStringChecker("command") == "edit")
        {
            ...
            if (clsSQL.Update(tableDefault,
                new string[,]{
                    ...
                    {"EMailAliasName","'"+clsSQL.CodeFilter(txtEMailAliasName.Text)+"'"},
