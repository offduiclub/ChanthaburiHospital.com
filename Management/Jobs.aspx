<%@ Page Title="" Language="C#" MasterPageFile="~/Management/MasterPage.master" AutoEventWireup="true" CodeFile="Jobs.aspx.cs" Inherits="Management_Jobs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBodyHead" Runat="Server">
    ...
    <div style="text-align:left;float:left;">
        ...
        ระบบจัดการข้อมูลตำแหน่งงานว่าง | <a href="/Management/Default.aspx">กลับสู่หน้าหลัก</a>
    </div>
