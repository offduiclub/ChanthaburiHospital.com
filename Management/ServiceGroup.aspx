<%@ Page Title="" Language="C#" MasterPageFile="~/Management/MasterPage.master" AutoEventWireup="true" CodeFile="ServiceGroup.aspx.cs" Inherits="Management_ServiceGroup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBodyHead" Runat="Server">
    ...
    <div style="text-align:left;float:left;">
        ...
        ระบบจัดการข้อมูลบริการ | <a href="/Management/">กลับสู่หน้าหลัก</a>
    </div>
                    ...
                    <ItemTemplate>
                        ...
                        <td class="GridViewItem">
                            <div style="text-align:left;padding:10px;">
                                <a href="/Management/Service.aspx?group=<%#DataBinder.Eval(Container.DataItem,"UID") %>&language=<%#DataBinder.Eval(Container.DataItem,"LanguageUID") %>">
