<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmailListManage.aspx.cs" Inherits="Management_EmailListManage" %>
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr class="GridViewItemNormal">
                        <td>
                            E-Mail</td>
                        <td style="text-align:left;padding-left:10px;">
                            <asp:TextBox ID="txtEMail" runat="server" MaxLength="500" width="99%" />
                        </td>
                    </tr>
                    <tr class="GridViewItemNormal">
                        <td>
                            E-Mail Alias Name</td>
                        <td style="text-align:left;padding-left:10px;">
                            <asp:TextBox ID="txtEMailAliasName" runat="server" MaxLength="100" width="99%" />
                        </td>
                    </tr>
                    <tr class="GridViewItemNormal">
                        <td>
