<%@ Page Title="" Language="C#" MasterPageFile="~/Management/MasterPage.master" AutoEventWireup="true" CodeFile="MedicalCenter.aspx.cs" Inherits="Management_MedicalCenter" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBodyHead" Runat="Server">
    ...
    <div style="text-align:left;float:left;">
        ...
        ระบบจัดการข้อมูลศูนย์สุขภาพ | <a href="/Management/MedicalCenterGroup.aspx">กลับสู่หน้าหลัก</a>
    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBody" Runat="Server">
    <uc1:ucColorBox ID="ucColorBox1" runat="server" UID="Child" ColorBoxIframeRefreshOnCloseName="cbIFrame" Height="90%"/>
                    ...
                    <ItemTemplate>
                        ...
                        <td class="GridViewItem">
                            <div style="text-align:left;padding:10px;">
                                ...
                                <a href="/Management/PhotoGallery.aspx<%#clsDefault.QueryStringMerge(new string[,]{{"globalid",DataBinder.Eval(Container.DataItem,"UID").ToString()},{"globalname","MedicalCenter"},{"globalpage","MedicalCenter.aspx"}}) %>"><div class="Icon24 Photo"></div> GalleryManage</a>
                            </div>
			            </td>
                        <td class="GridViewItem">
