<%@ Page Title="" Language="C#" MasterPageFile="~/Management/MasterPage.master" AutoEventWireup="true" CodeFile="IntroPage.aspx.cs" Inherits="Management_IntroPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBodyHead" Runat="Server">
    <div style="float:left;margin-right:5px;">
        <img src="/Images/Icon/icIntroPage.png" alt="IntroPage Manage" title="IntroPage Manage" />
    </div>
    <div style="text-align:left;float:left;">
        <h1>IntroPage Manage</h1>
        ระบบจัดการภาพอินโทรหน้าแรก | <a href="/Management/">กลับสู่หน้าหลัก</a>
    </div>
                    ...
                    <ItemTemplate>
                        ...
                        <td class="GridViewItem">
                            <div style="text-align:left;padding:10px;">
                                <img src="<%#DataBinder.Eval(Container.DataItem,"Photo") %>" style="width:400px;"/>
                        ...
                        <td class="GridViewItem">
				            <span class="Icon16 Calendar Normal"></span> FROM 
                            <div style="color:#FB4747;">
                                <%#(DataBinder.Eval(Container.DataItem, "ActiveFrom").ToString()!=""?DateTime.Parse(DataBinder.Eval(Container.DataItem,"ActiveFrom").ToString()).ToString("dd/MM/yyyy HH:mm"):"-")%>
                            </div>
                            <span class="Icon16 Calendar Normal"></span> TO 
                            <div style="color:#FB4747;">
                                <%#(DataBinder.Eval(Container.DataItem, "ActiveTo").ToString() != "" ? DateTime.Parse(DataBinder.Eval(Container.DataItem, "ActiveTo").ToString()).ToString("dd/MM/yyyy HH:mm") : "-")%>
                            </div>
                            <div>
                                Repeat : <%#(DataBinder.Eval(Container.DataItem, "ActiveIgnoreYear").ToString()=="1"?"ทุกปี":"ครั้งเดียว")%>
                            </div>
			            </td>
                        <td class="GridViewItem">
