<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PhotoGalleryManage.aspx.cs" Inherits="Management_PhotoGalleryManage" %>
                    ...
                    <tr class="GridViewItemNormal">
			            ...
			            <td style="text-align:left;padding-left:10px;">
                            ...
                            <span class="fontComment">* Width=<%=photoWidth.ToString() %>Height=<%=photoHeight.ToString()%></span><asp:RequiredFieldValidator 
                                ID="vdPhoto" runat="server" ControlToValidate="fuPhoto" CssClass="validDefault" 
