<%@ Page Title="" Language="C#" MasterPageFile="~/Management/MasterPage.master" AutoEventWireup="true" CodeFile="MedicalCenterGroup.aspx.cs" Inherits="Management_MedicalCenterGroup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBodyHead" Runat="Server">
    ...
    <div style="text-align:left;float:left;">
        <h1>Medical Center Manage</h1>
        ระบบจัดการข้อมูลกลุ่มศูนย์สุขภาพ | <a href="/Management/">กลับสู่หน้าหลัก</a>
    </div>
                    ...
                    <ItemTemplate>
                        ...
                        <td class="GridViewItem">
                            <div style="text-align:left;padding:10px;">
                                <a href="/Management/MedicalCenter.aspx?group=<%#DataBinder.Eval(Container.DataItem,"UID") %>&language=<%#DataBinder.Eval(Container.DataItem,"LanguageUID") %>">
