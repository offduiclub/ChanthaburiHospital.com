<%@ Page Title="" Language="C#" MasterPageFile="~/Management/MasterPage.master" AutoEventWireup="true" CodeFile="EmailTemplate.aspx.cs" Inherits="Management_EmailTemplate" %>
                        ...
                        <td class="GridViewItem">
                            <div style="text-align:left;padding:10px;">
                                ...
                                <div style="color:#E8A900;">
                                    <b style="color:#565757;">Subject : </b><%#DataBinder.Eval(Container.DataItem,"Subject") %>
                                </div>
                            </div>
			            </td>
                        <td class="GridViewItem">
				            <img src='<%#DataBinder.Eval(Container.DataItem, "Icon").ToString()%>' alt="ภาษา"/>
			            </td>
                        <td class="GridViewItem">
