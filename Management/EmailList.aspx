<%@ Page Title="" Language="C#" MasterPageFile="~/Management/MasterPage.master" AutoEventWireup="true" CodeFile="EmailList.aspx.cs" Inherits="Management_EmailList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBodyHead" Runat="Server">
    <div style="float:left;margin-right:5px;">
        <img src="/Images/Icon/icEMail.png" alt="E-Mail Manage" title="E-Mail Manage" />
    </div>
    <div style="text-align:left;float:left;">
        <h1>E-Mail Manage</h1>
        ระบบจัดการข้อมูลอีเมล์ที่ใช้บนเว็บไซต์ | <a href="/Management/">กลับสู่หน้าหลัก</a>
    </div>
                        ...
                        <td class="GridViewItem">
                            <div style="text-align:left;padding:10px;">
                                ...
                                <div style="color:#E8A900;">
                                    <b style="color:#565757;">E-Mail : </b><%#DataBinder.Eval(Container.DataItem,"EMail") %>
                                </div>
                                <div style="color:#E8A900;">
                                    <b style="color:#565757;">E-Mail Alias Name : </b><%#DataBinder.Eval(Container.DataItem,"EMailAliasName") %>
                                </div>
                            </div>
			            </td>
                        <td class="GridViewItem">
