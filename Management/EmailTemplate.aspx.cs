...
public partial class Management_EmailTemplate : System.Web.UI.Page
{
    ...
    protected void BindDefault()
    {
        ...
        strSQL.Append("INNER JOIN Language ON " + tableDefault + ".LanguageUID=Language.UID AND Language.Active='1' ");
