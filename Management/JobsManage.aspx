<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JobsManage.aspx.cs" Inherits="Management_JobsManage" ValidateRequest="false"%>
            ...
            <div class="GridView" style="padding:10px;">
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr class="GridViewItemNormal">
			            ...
			            <td style="text-align:left;padding-left:10px;">
			                <uc3:ucTextEditorFull ID="ucDetail" runat="server" />
			            </td>
		            </tr>
                    <tr class="GridViewItemNormal">
                        <td>
