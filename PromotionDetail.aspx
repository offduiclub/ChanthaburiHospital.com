<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PromotionDetail.aspx.cs" Inherits="PromotionDetial" %>
        ...
        <tr>
            <td align="left" style="font-weight: bold; font-size: large">
                ...
                <asp:Panel ID="pnAdmin" runat="server" Visible="false">
                    <a href="/PromotionForm.aspx?UID=<%=lblUID.Text.Trim() %>" class="cbIFrame"><span class="Icon16 Edit"></span></a>
