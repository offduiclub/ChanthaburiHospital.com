...
public partial class PromotionManage : System.Web.UI.Page
{
    ...
    public string tableDefault = "Promotion";
    public string webDefault = "Promotion/";
    public string webManage = "PromotionManage.aspx";
    public string pathUpload = "/Upload/Promotion/";
    ...
    protected void BindDetail(string id)
    {
        ...
        strSQL.Append("A.PromotionName Subject,");
        ...
        if (Request.QueryString["id"] != null && clsDefault.QueryStringChecker("command") == "edit")
        {
            ...
            if (clsSQL.Update(tableDefault,
                new string[,]{
                    ...
                    {"PromotionName","'"+clsSQL.CodeFilter(txtName.Text)+"'"},
