...
public partial class PackageManage : System.Web.UI.Page
{
    ...
    public string tableDefault = "Package";
    public string webDefault = "Package/";
    public string webManage = "PackageManage.aspx";
    public string pathUpload = "/Upload/Package/";
    ...
    private void BindControl()
    {
        ...
        dt = null; strSQL.Length = 0; strSQL.Capacity = 0;
        #region SQLQuery
        strSQL.Append("SELECT DepartmentUID,Name FROM MedicalCenter WHERE Active='1' AND LanguageUID=1;");
        #endregion
        dt = clsSQL.Bind(strSQL.ToString(), dbType, cs);
        if (dt != null && dt.Rows.Count > 0)
        {
            ...
            ddlDepartment.Items.Insert(0, new ListItem("- ไม่ระบุ -", "null"));
        }
    }
    protected void BindDetail(string id)
    {
        ...
        if (dt != null && dt.Rows.Count > 0)
        {
            ...
            {
                ddlDepartment.SelectedValue = dt.Rows[0]["DepartmentUID"].ToString();
            }
        ...
        if (Request.QueryString["id"] != null && clsDefault.QueryStringChecker("command") == "edit")
        {
            ...
            if (clsSQL.Update(tableDefault,
                new string[,]{
                    ...
                    {"DepartmentUID",(ddlDepartment.SelectedItem.Value!="null"?"'"+ddlDepartment.SelectedItem.Value+"'":"null")},
                    ...
                    {"PackageName","'"+clsSQL.CodeFilter(txtName.Text)+"'"},
                    {"Detail","'"+ucContent.Text.SQLQueryFilter()+"'"},
                    {"DetailSub","'"+clsSQL.CodeFilter(txtDetail.Text)+"'"},
                    {"UnitPrice",(txtPrice.Text.Trim()!=""?txtPrice.Text.SQLQueryFilter():"0")},
