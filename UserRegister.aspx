<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UserRegister.aspx.cs" Inherits="UserRegister" ValidateRequest="false" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" Runat="Server">
        ...
        <div style="float:left;">
            <div style="text-align:left;width:500px;">
                <div style="font-size:16pt;padding-top:5px;">
                    <asp:Label ID="lblHeader" runat="server" Text="ลงทะเบียนสมัครสมาชิก" 
    ...
    <div class="GridView" style="margin-top:10px;margin-bottom:10px;">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr class="GridViewItemNormal">
                <td>
				    <b><asp:Label ID="lblFPasswordConfirm" runat="server" 
                        Text="รหัสผ่าน อีกครั้ง" 
                        meta:resourcekey="lblFPasswordConfirmResource1"  /></b>
			    </td>
			    <td style="text-align:left;padding-left:10px;">
				    <asp:TextBox ID="txtPasswordConfirm" runat="server" MaxLength="100" 
                        TextMode="Password" Width="150px" 
                        meta:resourcekey="txtPasswordConfirmResource1" ></asp:TextBox>
                    <span class="Icon16 Star Normal"></span>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                        ControlToValidate="txtPasswordConfirm" CssClass="validDefault" Display="Dynamic" 
                        ErrorMessage="โปรดกรอก" SetFocusOnError="True" 
                        meta:resourcekey="RequiredFieldValidator3Resource1"></asp:RequiredFieldValidator>
                    <asp:CompareValidator ID="CompareValidator1" runat="server" 
                        ControlToCompare="txtPassword" 
                        ControlToValidate="txtPasswordConfirm" CssClass="validDefault" 
            ...
            <tr class="GridViewItemNormal">
			    ...
			    <td style="text-align:left;padding-left:10px;">
				    <asp:Button ID="btSubmit" runat="server" onclick="btSubmit_Click" 
                            CssClass="Button SubmitEN" meta:resourcekey="btSubmitResource1"/>
                        <asp:Button ID="btCancel" runat="server" 
                            CausesValidation="False" onclick="btCancel_Click"
                            CssClass="Button CancelEN" meta:resourcekey="btCancelResource1"/>
