<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucTextEditorFull.ascx.cs" Inherits="UserControl_ucTextEditorFull" %>
...
<div>
    <iframe id="ifPhotoInsert" height="35px" width='<%=Width %>' frameborder="0" src='<%=this.ResolveClientUrl("ucTextEditorUpload.aspx") %>' scrolling="no"></iframe>
</div>
