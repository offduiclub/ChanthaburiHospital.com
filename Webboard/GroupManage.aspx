<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GroupManage.aspx.cs" Inherits="Webboard_GroupManage" %>
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr class="GridViewItemNormal">
			            ...
			            <td style="text-align:left;padding-left:10px;">
				            <asp:DropDownList ID="ddlWebboardType" runat="server" />
			            </td>
		            </tr>
                    <tr class="GridViewItemNormal">
                        <td>
                    ...
                    <tr class="GridViewItemNormal">
                        <td>
                            Meta Keywords</td>
                        <td style="text-align:left;padding-left:10px;">
                            <asp:TextBox ID="txtMetaKeywords" runat="server" MaxLength="500" width="99%" />
                        </td>
                    </tr>
                    <tr class="GridViewItemNormal">
                        <td>
                    ...
                    <tr class="GridViewItemNormal">
                        <td>
                            Global UID</td>
                        <td style="text-align:left;padding-left:10px;">
                            <asp:TextBox ID="txtGlobalUID" runat="server" MaxLength="10" width="30" />
                        </td>
                    </tr>
                    <tr class="GridViewItemNormal">
                        <td>
