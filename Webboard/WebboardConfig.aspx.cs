...
public partial class Webboard_WebboardConfig : System.Web.UI.Page
{
    #region Global Variable
    public clsDefault clsDefault = new clsDefault();
    clsSQL clsSQL = new clsSQL();
    clsSecurity clsSecurity = new clsSecurity();
    public string tableDefault = "WebboardConfig";
    public string webDefault = "/Webboard/";
    public string webManage = "WebboardConfigManage.aspx";
    #endregion
    ...
    protected void BindDefault()
    {
        ...
        strSQL.Append(tableDefault + ".Value,");
    ...
    protected void btDGSubmit_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < gvDefault.Rows.Count; i++)
        {
            ...
            TextBox txtDGValue = (TextBox)gvDefault.Rows[i].FindControl("txtDGValue");
            ...
            if (lblDGID != null && cbDGActive != null)
            {
                ...
                strSQL.Append(tableDefault + " ");
                strSQL.Append("SET ");
                strSQL.Append("Value='"+clsSQL.CodeFilter(txtDGValue.Text)+"',");
