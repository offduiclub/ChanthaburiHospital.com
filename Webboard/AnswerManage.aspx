<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AnswerManage.aspx.cs" Inherits="Webboard_AnswerManage" ValidateRequest="false" %>
        ...
        <asp:Panel ID="pnDetail" runat="server">
            <div class="GridView" style="padding:10px;">
                <div class="GridViewHeader">
                    <h2><asp:Label ID="lblHeader" runat="server" Text="ตอบคำถาม" /></h2>
                </div>
                    ...
                    <tr class="GridViewItemNormal">
			            <td style="text-align:left;padding:10px;">
                            <h5 style="margin-top:5px;">
                                <asp:Label ID="lblHeaderDetail" runat="server" Text="รายละเอียดคำตอบ" />
                            </h5>
                            ...
                            <div id="dvAnonymous" runat="server" visible="true">
                                <div style="float:left;margin-right:20px;">
                                    <h5 style="margin-top:5px;">
                                        <asp:Label ID="lblHeaderCName" runat="server" Text="ผู้ตอบคำถาม" />
                                    </h5>
